...
import ui.advanced_appearence.ShadowBorder;
...
public class TopicPanel extends ToastPanel implements MouseListener, LeapListener {
	...
	public TopicPanel(String topic, int duration) {
		...
		LeapManager.getDefaultLeapManager().addLeapListener(this.saveImage, this);
		...
		setBorder(new ShadowBorder(thickness, arc));
		setOpaque(false);
	}
