...
import ui.advanced_appearence.RoundLineBorder;
import ui.part.head_portrait.HeadPortraitLabel;
import util.DesaturateFilter;
...
public class ScoreLabel extends JPanel {
	...
	public void setBounds(int x, int y, int width, int height) {
		...
		painterLabel.setBorder(new RoundLineBorder(Color.RED, 4, (headPortraitLabel.getArc() >> 1) - 4));
		guessedLabel.setBorder(new RoundLineBorder(Color.BLUE, 5, (headPortraitLabel.getArc() >> 1) - 5));
	...
	public void setClient(String progressId, String name, int headPortrait) {
		...
		headPortraitLabel.setImage(FileUtil.getBufferedImage("head_portrait/" + (headPortrait + 100 + "").substring(1) + ".jpg"));
	}
